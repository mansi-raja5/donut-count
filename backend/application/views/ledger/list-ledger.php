    ...
    <div class="portlet-body">
        ...
        <div class="row">
            <div class="col-md-4 mb10 pull-right text-right">
                <a href="<?php echo base_url('statement/import'); ?>" class="btn blue" id="new_project">Add Ledger</a>
            </div>
        </div>
        <br/>
        <div class="row">
...
<script>
      $(document).ready(function () {
        if ($("#tblListing").length) {
            ...
            cOptions.srNo = true;
            cOptions.mColumns = [1, 2, 3, 4, 5,6,7];
    ...
    function setConfirmDetails(value) {
        ...
        $("#ConfirmDeleteModal").find(".modal-body").children("p").html("Do you really want to delete this ledger statement");
