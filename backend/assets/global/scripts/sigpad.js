...
function SignaturePad (selector, options) {
  ...
  function drawIt () {
    ...
    $(settings.drawItDesc, context).val('d')
  ...
  function typeIt () {
    ...
    $(settings.typeItDesc, context).val('t')
...
$.fn.signaturePad.defaults = {
  ...
  , typeItDesc : '.typeOfSig' // The description for TypeIt actions
  , drawItDesc : '.typeOfSig' // The description for DrawIt actions (hidden by default)
